 ...
 */
package srour.said.ul.TCPChat.server;
...
import srour.said.ul.TCPChat.Command;
import srour.said.ul.TCPChat.CommandFormatException;
import srour.said.ul.TCPChat.ServerReply;
import srour.said.ul.TCPChat.ServerReplyException;
...
//				System.out.println(client.name + " send " + messageFromClient);
				...
				if (!client.isRegistered()) {
					...
					client.sendReply(ServerReply.ENREGISTREMENT_OK,
							"Hello " + client.getName() + ", Welcome to our tiny chat app" + getClientHelp());
